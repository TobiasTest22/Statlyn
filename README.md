...
Official logo usage is documented in `docs/branding.md`. Visual analytics components are documented in `docs/visual-analytics-components.md`. The currently available repo assets are `StatLyn_Logo.png`, `StatLyn_Logo_Reversed.png`, `Statlyn_Logo_Black-text.png` and `Statlyn_Logo_White-text.png`.
