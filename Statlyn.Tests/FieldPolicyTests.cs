...
namespace Statlyn.Tests
{
    public sealed class FieldPolicyTests
    {
        ...
        public void ProfessionalismVisibleFactIsBlockedButQualitativeScoutNoteCanDisplay()
        {
            ...
            raw.Fields[PlayerFieldKey.ScoutVisiblePersonalityNote] = new RawFieldValue(
        ...
        public void UnknownFieldKeyIsDeniedByDefault()
        {
            ...
            raw.Fields[PlayerFieldKey.Unknown] = new RawFieldValue(PlayerFieldKey.Unknown, "MysteryMetric", 99, FieldValueKind.Number, 90);
        ...
        public void LicensedExternalDataIsBlockedIfSourceIsNotLicensed()
        {
            ...
            raw.Fields[PlayerFieldKey.LicensedExternalData] = new RawFieldValue(PlayerFieldKey.LicensedExternalData, "xG", 0.42, FieldValueKind.Number, 80);
        ...
        public void PlayerFaceImageIsBlockedIfSourceDoesNotPermitImages()
        {
            ...
            raw.Fields[PlayerFieldKey.PlayerFaceImage] = new RawFieldValue(PlayerFieldKey.PlayerFaceImage, "PlayerFaceImage", "faces/player.png", FieldValueKind.ImageReference, 80);
        ...
        public void NationalityFlagCanDisplayIfBundledSafeFlagAssetsAreAllowed()
        {
            ...
            raw.Fields[PlayerFieldKey.NationalityFlag] = new RawFieldValue(PlayerFieldKey.NationalityFlag, "NationalityFlag", "flags/RO.svg", FieldValueKind.FlagReference, 90);
        ...
        {
            var raw = TestPlayers.CreateExternalPlayer(isLicensed: true);
            raw.Fields[PlayerFieldKey.DisplayName] = new RawFieldValue(PlayerFieldKey.DisplayName, "DisplayName", "Synthetic Name", FieldValueKind.Text, 100);
            raw.Fields[PlayerFieldKey.TechnicalAttribute] = new RawFieldValue(PlayerFieldKey.TechnicalAttribute, "Finishing", 18, FieldValueKind.Number, 100);
        ...
        public void CsvFixtureImportsSyntheticRowsAndBlocksCurrentAbilityColumn()
        {
            ...
            var masked = new ScoutingKnowledgeFirewall().Mask(players.Value!.Single());
