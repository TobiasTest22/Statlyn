...
SQLite remains the current storage implementation. It stores masked players, visible permitted fields, source metadata, workflow records, aggregate benchmark snapshots and safe audit counts.
